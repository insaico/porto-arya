          ...
          >
            <div className="space-y-4">
              ...
              <motion.p className="text-xl text-muted-foreground max-w-[600px]" {...staggerDelay(0.2)}>
                Experienced in full-stack development and DevOps Engineering. 
                Currently learning and experimenting with blockchain, smart contract creation, and AI implementation for business.
              </motion.p>
            </div>
